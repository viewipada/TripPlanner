                  ...
                  children: [
                    ...
                    CoolDropdown(
                      ...
                      onChange: (selectedItem) {
                        ...
                        createLocationViewModel
                            .updateLocationCategoryValue(selectedItem['label']);
                      },
                      ...
                      resultBD: BoxDecoration(
                        ...
                        border: Border(
                          top: BorderSide(
                              color:
                                  createLocationViewModel.locationCategoryValid
                    ...
                    createLocationViewModel.locationType.isNotEmpty
                        ? IgnorePointer(
                            ...
                            child: CoolDropdown(
                              ...
                              onChange: (selectedItem) {
                                createLocationViewModel.updateLocationTypeValue(
                                    selectedItem['label']);
                              },
                              resultPadding: const EdgeInsets.symmetric(
                                horizontal: 15,
                            ...
                            children: [
                              Expanded(
                                child: TextFormField(
                                  ...
                                  decoration:
                                      const InputDecoration(hintText: "ต่ำสุด"),
                                  onChanged: (value) => createLocationViewModel
                              ...
                              Expanded(
                                child: TextFormField(
                                  ...
                                  decoration:
                                      const InputDecoration(hintText: "สูงสุด"),
                                  onChanged: (value) => createLocationViewModel
