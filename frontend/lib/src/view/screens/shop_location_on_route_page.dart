...
class ShopLocationOnRoutePage extends StatefulWidget {
  final List<int> days;
  final List<TripItem> tripItems;
  final List<ShopResponse> locationList;

  ShopLocationOnRoutePage({
    required this.days,
  ...
  @override
  _ShopLocationOnRoutePageState createState() => _ShopLocationOnRoutePageState(
      this.days, this.tripItems, this.locationList);
}

class _ShopLocationOnRoutePageState extends State<ShopLocationOnRoutePage> {
  final List<int> days;
  List<TripItem> tripItems;
  final List<ShopResponse> locationList;

  _ShopLocationOnRoutePageState(this.days, this.tripItems, this.locationList);
      ...
      body: SafeArea(
        child: Stack(
          children: [
            FutureBuilder(
              future:
                  tripStepperViewModel.getShopMarkers(tripItems, locationList),
...
Widget pinCard(ShopResponse location) {
  return Container(
    decoration: BoxDecoration(
