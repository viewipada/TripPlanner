...
class EditLocationRequestPage extends StatefulWidget {
  final int locationId;

  EditLocationRequestPage({required this.locationId});
  @override
  _EditLocationRequestPageState createState() =>
      _EditLocationRequestPageState(this.locationId);
}

class _EditLocationRequestPageState extends State<EditLocationRequestPage> {
  ...
  void initState() {
    super.initState();
    Provider.of<CreateLocationViewModel>(context, listen: false)
        .getLocationRequestById(locationId);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
          ...
          leading: TextButton(
            onPressed: () => showDialog<String>(
              ...
              builder: (BuildContext context) => AlertDialog(
                ...
                content: const Text(
                  'หากคุณยกเลิก ข้อมูลการแก้ไขจะไม่ถูกบันทึก',
                  style: TextStyle(
                    fontSize: 14,
                    color: Palette.AdditionText,
                  ),
        ...
        body: SafeArea(
          child: createLocationViewModel.locationRequest == null
              ? Loading()
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              initialValue:
                                  createLocationViewModel.locationName,
                              maxLines: 1,
                              validator: (value) {
                          ...
                          Padding(
                            ...
                            child: CoolDropdown(
                              defaultValue:
                                  createLocationViewModel.defaultCategotyValue,
                              dropdownList:
                                  createLocationViewModel.locationCategory,
                          ...
                          createLocationViewModel.locationType.isNotEmpty
                              ? IgnorePointer(
                                  ignoring: createLocationViewModel
                                  ...
                                  child: Padding(
                                    ...
                                    child: CoolDropdown(
                                      defaultValue: createLocationViewModel
                                          .defaultLocationTypeValue,
                                      dropdownList:
                          ...
                          createLocationViewModel.locationCategoryValue ==
                                  'ที่พัก'
                              ? Subtitle('ช่วงราคา ', '*')
                              : SizedBox(),
                          createLocationViewModel.locationCategoryValue ==
                          ...
                          Padding(
                            ...
                            child: CoolDropdown(
                              defaultValue:
                                  createLocationViewModel.provinceList.first,
                              dropdownList:
                                  createLocationViewModel.provinceList,
                              placeholder: 'กรุณาเลือก',
                              dropdownHeight: 70,
                              dropdownItemGap: 0,
                              dropdownWidth: SizeConfig.screenWidth -
                              ...
                              resultBD: BoxDecoration(
                                ...
                                border: Border(
                                  top: BorderSide(
                                      color:
                                          createLocationViewModel.provinceValid
                                              ? Palette.BorderInputColor
                                              : Colors.red),
                                  bottom: BorderSide(
                                      color:
                            ...
                            child: Container(
                              ...
                              child: TextButton.icon(
                                ...
                                icon: Icon(
                                  ...
                                  color: createLocationViewModel.locationPin ==
                                          null
                                      ? Palette.InfoText
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              initialValue: createLocationViewModel.description,
                              maxLines: 100,
                              maxLength: 360,
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              initialValue: createLocationViewModel.website,
                              maxLines: 1,
                              onChanged: (value) => createLocationViewModel
                                  .updateWebsite(value.trim()),
                            ),
                          ),
                          Container(
                              ...
                              Expanded(
                                child: Row(
                                  children: [
                                    Radio<bool>(
                                      value: true,
                                      groupValue: createLocationViewModel
                                          .knowOpeningHour,
                          ...
                          createLocationViewModel.images != null ||
                                  createLocationViewModel.imageUrl != null
                              ? InkWell(
                                  ...
                                  onLongPress: () => showDialog(
                                    ...
                                    builder: (_) => Dialog(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: createLocationViewModel.images !=
                                                null
                                            ? Image.file(
                                  ...
                                  child: Container(
                                    ...
                                    child: Card(
                                      ...
                                      child: createLocationViewModel.images !=
                                          ...
                                          : Image.network(
                                              createLocationViewModel.imageUrl!,
                                              height:
                                                  getProportionateScreenHeight(
                                                      250),
                                              width: double.infinity,
