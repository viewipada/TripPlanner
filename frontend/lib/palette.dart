...
class Palette {
  ...
  static const PrimaryColor = Color(0xff41A4C3);
  static const SecondaryColor = Color(0xffF47645);
  static const Outline = Color.fromRGBO(21, 21, 21, 0.2);
  static const DarkGrey = Color(0xff374A59);
  ...
  static const MaterialColor PrimarySwatchColor = const MaterialColor(
    0xff41A4C3,
    const <int, Color>{
      50: const Color(0xff41A4C3), //10%
      100: const Color(0xff41A4C3), //20%
      200: const Color(0xff41A4C3), //30%
      300: const Color(0xff41A4C3), //40%
      400: const Color(0xff41A4C3), //50%
      500: const Color(0xff41A4C3), //60%
      600: const Color(0xff41A4C3), //70%
      700: const Color(0xff41A4C3), //80%
      800: const Color(0xff41A4C3), //90%
  ...
  static const HeadingText = Color(0xff081F32);
}
